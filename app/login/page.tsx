      ...
      <Card className="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <CardContent>
          ...
          <button
            ...
            className="flex w-full justify-center items-center rounded-md bg-background px-3 py-1.5 text-sm font-semibold leading-6 text-foreground shadow-sm ring-1 ring-inset ring-input hover:bg-accent opacity-50 cursor-not-allowed"
            disabled
          >
